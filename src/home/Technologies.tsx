...
import nodeLogo from '../assets/skills/Nodejs_logo.png';
            ...
            <div className="flex justify-center flex-wrap">
                <div className="bg-black h-32 w-32 lg:h-44 lg:w-44 m-3 lg:m-5 xl:m-10 flex flex-col">
                    <div className="px-5 mt-auto">
                        <img src={angularLogo} alt="Angular logo" loading="lazy" className="w-3/4 mx-auto"/>
                    </div>
                    <p className="text-center text-xl m-auto">Angular</p>
                </div>
                <div className="bg-black h-32 w-32 lg:h-44 lg:w-44 m-3 lg:m-5 xl:m-10 flex flex-col">
                    <div className="px-5 mt-auto">
                        <img src={nodeLogo} alt="Node JS logo" loading="lazy" className="w-3/4 mx-auto"/>
                    </div>
                    <p className="text-center text-xl m-auto">Node JS</p>
                </div>
                <div className="bg-black h-32 w-32 lg:h-44 lg:w-44 m-3 lg:m-5 xl:m-10 flex flex-col">
                    <div className="px-5 mt-auto">
                        <img src={firebaseLogo} alt="Firebase logo" loading="lazy" className="w-3/4 mx-auto"/>
                    </div>
                    <p className="text-center text-xl m-auto">Firebase</p>
                </div>
                <div className="bg-black h-32 w-32 lg:h-44 lg:w-44 m-3 lg:m-5 xl:m-10 flex flex-col">
                    <div className="px-5 mt-auto">
                        <img src={mongoDBLogo} alt="MongoDB logo" loading="lazy" className="w-3/4 mx-auto"/>
                    </div>
